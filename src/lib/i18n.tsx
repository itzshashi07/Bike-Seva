...
const dict = {
  en: {
    ...
    book: {
      ...
      name: "Full Name", namePh: "Ramesh Kumar",
      mobile: "Mobile Number", mobilePh: "10-digit mobile",
      pickup: "Pickup Village", pickupPh: "e.g. Rampur",
      drop: "Drop Village", dropPh: "e.g. Sitapur",
  ...
  hi: {
    ...
    book: {
      ...
      name: "पूरा नाम", namePh: "रमेश कुमार",
      mobile: "मोबाइल नंबर", mobilePh: "10 अंकों का नंबर",
      pickup: "पिकअप गाँव", pickupPh: "जैसे रामपुर",
      drop: "ड्रॉप गाँव", dropPh: "जैसे सीतापुर",
